...
class ax_config:
    def __init__(self):
        ...
        self.loss_parameters = ["image_loss", "grad",'KL_loss']  # loss weight
        ...
        self.losses = {
            'image_loss': image_loss_func,"grad":vxm.losses.Grad('l2', loss_mult=self.int_downsize).loss ,
            "KL_loss": vxm.losses.KL().loss,
            }# {name:loss}
